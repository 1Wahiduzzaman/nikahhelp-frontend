	...
	<div class="col-lg-4 col-xl-12 col-md-4 col-sm-12">
		<a-card class="team-card" style="min-height: 500px">
			...
			<a-row style="margin-top: 48px">
				<a-col :span="24">
					<span class="joining-message">You're joining as a</span>
					<span class="candiadate-text">member</span>
				</a-col>
			</a-row>
			<a-row>
				<!-- <a-col :span="24" class="form-label"> -->
				<!-- <a-col :span="8">
                <div>Invited By</div>
                <div>Team name</div>
                <div>Total team member</div>
                <div>Team create date</div>
            </a-col> -->
				<!-- <a-col :span="8" class="form-values">
                <div>:Sogir mia(Uncle)</div>
                <div>:Best Team</div>
                <div>:4</div>
                <div>:10/10/2020</div>
            </a-col> -->
				<!-- <a-col :span="8" align="center">
                <a-button class="confirm-button">Confirm</a-button>
            </a-col> -->
				<!-- </a-col> -->
				<div class="space-align-container" style="margin-top: 46px">
					<div class="space-align-block">
						...
						<a-space align="center" style="padding-left: 10px">
							<a-button
