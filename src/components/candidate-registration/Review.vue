<template>
	<div class="review-publish">
		...
		<fieldset v-if="candidateData && candidateData.preference" class="review">
											...
											>:<span class="ml-3">
												{{
													$store.state.candidateInfo.study_level_options[
														candidateData.preference.pre_study_level_id
													].name
												}}
											</span></span
										>
					...
					<div class="row">
						...
						<div class="col-md-6 col-6 mb-3">
							<div class="profile-img text-center">
								<img
									:src="
										$store.state.candidateInfo.review.personal.per_avatar_url
									"
									alt="img"
									height="250"
									width="200"
						...
						<div class="col-md-6 col-6 mb-3">
							<div class="profile-img text-center">
								<img
									:src="
										$store.state.candidateInfo.review.personal
											.per_main_image_url
									"
									alt="img"
									height="250"
...
export default {
	...
	methods: {
		async getCandidateData() {
			try {
				await this.$store.dispatch("getCandidateAllInfo");
			} catch (error) {
				alert(this.error);
			}
		},
	...
	computed: {
		candidateData() {
			const candidateAllInfo = this.$store.getters["candidateAllInfo"];
